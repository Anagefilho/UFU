	...
	do{
		...
		switch(rep){
			case 1:
				...
				strcpy(p1, "-doutoras");	//apagar
				strcpy(p2, "medicas");	//apagar
				strcpy(p3, "-meninos");	//apagar
			
				printf("Antes de retirar genero\n");
				printf("%s / %s / %s\n", p1, p2, p3);
			
				preprocessamento(p1, p2, p3);
			
				printf("Depois de retirar genero\n");
				printf("%s / %s / %s\n", p1, p2, p3);
